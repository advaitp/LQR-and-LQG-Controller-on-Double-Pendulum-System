 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Dec 19 03:27:57 2021
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Cart_Pendulum
...
#define CONT_STATES_IC                 [0,0,0,0,0,0]
...
extern void Cart_Pendulum_Outputs_wrapper(const real_T *u,
  real_T *x,
  const real_T *xC);
extern void Cart_Pendulum_Derivatives_wrapper(const real_T *u,
  real_T *x,
  real_T *dx,
  real_T *xC);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  Cart_Pendulum_Outputs_wrapper(u, x, xC);
}
...
static void mdlDerivatives(SimStruct *S)
{
  ...
  real_T *dx = ssGetdX(S);
  real_T *xC = ssGetContStates(S);
  Cart_Pendulum_Derivatives_wrapper(u, x, dx, xC);
}
